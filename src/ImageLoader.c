...
#else
       LoadImageFromData(GetImgDataForFlag(pFlagInformation, flag), GetImgDataSizeForFlag(pFlagInformation, flag ) );//sizeof(af));
#endif
//#else
//      nSDL_LoadImage( GetImgForFlag(pFlagInformation, flag) );
//#endif
}
